      ...
      <Container>
        ...
        <div className="mt-40 flex items-center justify-center">
          <div className="grid grid-cols-1 gap-40 sm:grid-cols-2 md:grid-cols-3">
            <div className=" relative flex w-[30rem] sm:w-[30rem] flex-col px-10  items-center justify-center gap-10 border-2  border-t-0 border-red-gtext py-16 after:absolute after:-left-2 after:top-0 after:h-full after:w-[105%] after:bg-gradient-to-t after:from-transparent after:to-white">
