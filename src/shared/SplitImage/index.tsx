...
const SplitImage: React.FC<SplitImageProps> = ({ image, className }) => {
  return (
    <figure className={`flex items-center gap-4 ${className ? className : ''}`}>
      <div className="max-h-[50.5rem] max-w-[60rem] w-[70rem] md:w-[32rem] sm:h-[50.5rem] overflow-hidden rounded-lg">
